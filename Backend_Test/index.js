...
const options = {
  definition: {
    ...
    info: {
      ...
      version: "1",
      description: "This is a Test Case API application made with ExpressJS and documented with Swagger",
      contact: {
        name: "Rafi Reyhan",
...
db.once("open", () => {
  ...
  console.log("Klik http://localhost:3001/docs untuk membuka dokumentasi API");
});